 // WhatsApp Chat Widget Script
        (function() {
            // Configuration
            const config = {
                phoneNumber: '233265196017', // Replace with your WhatsApp number (include country code, no + symbol)
                businessName: 'Dr. Adelina Mensah',
                welcomeMessage: 'Hey, welcome to my page, How can i help you?',
